  ...
  return (
    <div ref={containerRef} className="relative w-full max-w-[760px] mx-auto select-none">
      <div className="flex items-center gap-2 mb-4 px-1">
        <svg className="w-3.5 h-3.5 text-slate-700 dark:text-slate-300 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div style={{ position: 'relative', perspective: '900px', perspectiveOrigin: '50% -10%', width: '100%' }}>
        ...
        >
          {/* PERMUKAAN ATAS TUTUP — brushed stainless steel minimalis */}
          <div
            style={{
              position: 'absolute', top: 0, left: 0, right: 0,
              height: `${stickerH}px`,
              borderRadius: '8px 8px 0 0',
              background: 'linear-gradient(168deg, #f8fafc 0%, #e2e8f0 30%, #cbd5e1 60%, #94a3b8 100%)',
              border: '1.5px solid #94a3b8', borderBottom: 'none',
              boxShadow: 'inset 0 1px 3px rgba(255,255,255,0.7)',
              overflow: 'hidden',
            }}
          >
            <div style={{ position: 'absolute', inset: 0, background: 'repeating-linear-gradient(90deg, transparent 0px, transparent 3px, rgba(255,255,255,0.04) 3px, rgba(255,255,255,0.04) 4px)', pointerEvents: 'none' }} />
            <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: '30%', background: 'linear-gradient(to bottom, rgba(255,255,255,0.5) 0%, transparent 100%)', pointerEvents: 'none' }} />
            <div style={{ position: 'absolute', inset: '7px', borderRadius: '5px', border: '1px solid rgba(148,163,184,0.4)', pointerEvents: 'none' }} />
            ...
            <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: `0 ${containerWidth * 0.03}px` }}>
              {/* TOP: Label Kiri */}
              <div style={{ position: 'relative', width: `${stickerW}px`, height: `${stickerH}px`, flexShrink: 0, overflow: 'hidden', borderRadius: '2px 2px 0 0', boxShadow: '0 1px 4px rgba(0,0,0,0.06)', transform: 'rotate(-0.3deg)' }}>
          ...
          >
            <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'stretch', justifyContent: 'space-between', padding: `0 ${containerWidth * 0.03}px`, overflow: 'hidden' }}>
              {/* SIDE: Lipatan Kiri */}
              <div style={{ width: `${stickerW}px`, height: '100%', flexShrink: 0, overflow: 'hidden', backgroundColor: '#fff', position: 'relative', transform: 'rotate(-0.3deg)', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
                ...
                <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to bottom, rgba(0,0,0,0.2) 0%, rgba(0,0,0,0.08) 100%)', pointerEvents: 'none' }} />
              </div>
      ...
      <div className="mt-6 grid grid-cols-2 gap-3 text-[11px] text-center">
        <div className="flex flex-col items-center gap-1">
          <div className="px-3 py-1 rounded-full font-semibold bg-[#E1F3FE] dark:bg-slate-800 text-[#1F6C9F] dark:text-slate-200 border border-[#cfe6f9] dark:border-slate-700 text-[10px] tracking-wider uppercase">Label Kiri — SPPG &amp; Batas Waktu</div>
          <div className="text-slate-500 dark:text-slate-400 text-[10px] font-mono tracking-tight">Ditempel &amp; dilipat di sisi kiri tutup ompreng</div>
        </div>
        <div className="flex flex-col items-center gap-1">
          <div className="px-3 py-1 rounded-full font-semibold bg-[#E1F3FE] dark:bg-slate-800 text-[#1F6C9F] dark:text-slate-200 border border-[#cfe6f9] dark:border-slate-700 text-[10px] tracking-wider uppercase">Label Kanan — Larangan &amp; Pengaduan</div>
          <div className="text-slate-500 dark:text-slate-400 text-[10px] font-mono tracking-tight">Ditempel &amp; dilipat di sisi kanan tutup ompreng</div>
        </div>
      </div>

      <div className="mt-4 pt-3 border-t border-slate-200 dark:border-slate-800 text-center text-[11px] text-slate-500 dark:text-slate-400 flex items-center justify-center gap-2 flex-wrap font-mono">
        <span className="font-semibold text-slate-800 dark:text-slate-200 tracking-tight uppercase text-[10px] px-1.5 py-0.5 rounded bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700">Surat Edaran BGN 2026:</span>
        <span>Label Kiri (7x5 cm) + Label Kanan (7x5 cm) &mdash; segel tutup ompreng stainless steel</span>
      </div>
    </div>
  )
}
